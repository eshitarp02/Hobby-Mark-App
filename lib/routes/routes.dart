...
import 'package:to_do_app/presentation/pages/activity_log_history/activity_log_history_page.dart';
  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          name: Routes.activityLog.name,
          path: Routes.activityLog.path,
          pageBuilder: Routes.activityLog.pageBuilder,
        ),
      ],
    ),
  ],
...
class Routes {
  ...
  static RouteInfo activityLog = RouteInfo(
    name: 'activityLog',
    path: '/activityLog',
    pageBuilder: (context, state) => MaterialPage(
      key: state.pageKey,
      child: const ActivityLogHistoryPage(),
    ),
  );
}
