...
import 'package:to_do_app/data/suggestion/suggestion_api_impl.dart';
...
import 'package:to_do_app/domain/repositories/suggestions/suggestions_repository_impl.dart';
...
void _injectRepositories() {
  ...
  GetIt.I.registerLazySingleton<SuggestionsRepository>(
...
void _injectApi() {
  ...
  GetIt.I.registerLazySingleton<SuggestionApi>(() => SuggestionApiImpl());
}
